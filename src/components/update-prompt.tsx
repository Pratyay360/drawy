        ...
        <Layout
          ...
          content={
            <LayoutContent padding={4}>
              <VStack gap={2}>
                <Text>A new version of Drawy is available. Update to {update.version}?</Text>
                {update.notes ? <Text type="supporting">{update.notes}</Text> : null}
              </VStack>
            </LayoutContent>
          }
          footer={
            <LayoutFooter hasDivider padding={4}>
              <HStack justify="end" gap={2}>
                ...
                <Button
                  ...
                  variant="primary"
                  icon={<Icon icon={installing ? Loader2 : RefreshCw} size="sm" />}
