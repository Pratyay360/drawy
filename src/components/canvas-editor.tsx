...
export function CanvasEditor({
	...
	}, [id, excalidrawAPI, fetchCanvas, setCollaborators]);
	...
	const handleExcalidrawChange = useCallback(
		...
		[id, broadcastScene, setElements, setAppState, setSaveStatus],
	);
	...
	const handleImportFromJSON = useCallback(() => {
		...
		input.click();
	}, [excalidrawAPI, setElements, setAppState, setSaveStatus]);
	...
	// Reset store state when the editor unmounts so a later canvas mount starts fresh.
	useEffect(() => {
		return () => {
			resetCanvas();
		};
