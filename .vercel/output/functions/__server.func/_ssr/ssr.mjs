...
import { H3Event, clearSession, getSession, toResponse, updateSession } from "../_libs/h3-v2+rou3+srvx.mjs";
import { _getRenderedMatches, attachRouterServerSsrUtils, bindSsrResponseToRequest, createRawStreamRPCPlugin, createSerializationAdapter, defaultSerovalPlugins, disposeSsrResponseDetached, executeRewriteInput, fromJSON, getNormalizedURL, getOrigin, getScriptPreloadAttrs, getStylesheetHref, invariant, isNotFound, isRedirect, isResolvedRedirect, isSsrResponse, makeSerovalPlugin, mergeHeaders, normalizeSsrResponse, parseRedirect, replaceSsrResponse, resolveManifestAssetLink, resolveManifestCssLink, rootRouteId, stripSsrResponseBody, toCrossJSONAsync, toCrossJSONStream, waitForRequest } from "../_libs/@tanstack/router-core+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-6I6_PDem.mjs");
...
var manifest = {
	"1b90f4feb8175e40785b2aba78db201a0b0269327953c16d833808a1166bd7cd": {
		...
		importer: () => import("./session-CNm3iPda.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CcE2zVrw.mjs").then((n) => n.router_exports),
		import("./start-tZnO21TC.mjs"),
		import("./empty-plugin-adapters-Di8Kf1qi.mjs")
	]);
	return {
		routerEntry,
		startEntry,
...
//#endregion
export { TSS_SERVER_FUNCTION, clearSession$1, createServerFn, getRequestHeaders, getServerFnById, getSession$1, ssr_exports, updateSession$1 };
